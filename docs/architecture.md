...
└──────────────────┬───────────────────────────┘
                   ▼
┌──────────────────────────────────────────────┐
│ BayEngage platform                           │  data and execution
└──────────────────────────────────────────────┘
```
...
|---|---|---|
| Reading a customer, creating a campaign, sending | **BayEngage MCP** | The capability to create a segment |
...
| Consent, suppression, hard caps | **BayEngage platform** | Enforcement, not restatement |
...
APPROVE    a human decides                                       —
   ↓
EXECUTE    apply through BayEngage MCP                           mutation / high_impact
   ↓
...
Skills declare abstract capability identifiers — `bayengage.customer_intelligence`, not a tool name. The
