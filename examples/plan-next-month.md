...
| Capability | Read for |
|---|---|
| `bayengage.marketing_calendar` | What is already committed in the window |
| `bayengage.campaign_analytics` | Which campaign types have produced revenue here |
| `bayengage.order_intelligence` | Seasonality, revenue concentration by category |
| `bayengage.customer_intelligence` | Audience availability, engagement, lifecycle mix |
| `bayengage.product_intelligence` | Launches, stock posture, what there is to say |
| `bayengage.automation` | Contact load already committed to each audience |
| `bayengage.suppression_and_consent` | Channel eligibility, frequency caps |
