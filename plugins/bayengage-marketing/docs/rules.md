...
**Deterministic platform enforcement.** Consent, suppression, legal opt-out, sending limits and hard
frequency caps are enforced by BayEngage services. The rules in this package exist to stop an agent from
*planning* something the platform would reject, or something the platform cannot see is a bad idea. They
do not reimplement enforcement ([global-rules.md#G10](../rules/global-rules.md)).
