...
| Status | Meaning |
|---|---|
| `foundation` | The contract is established and the reasoning is real, but the workflow has not been hardened against a live BayEngage MCP |
...
independently of them. A release is a tag of the form `bayengage-marketing@<version>`, where the version
