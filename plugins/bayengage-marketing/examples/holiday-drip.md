...
`bayengage.order_intelligence` for prior-period revenue around the date; `bayengage.product_intelligence`
for catalogue fit; `bayengage.customer_intelligence` for audience locale;
`bayengage.marketing_calendar` for surrounding commitments; `bayengage.campaign_analytics` for last
year's results.
