...
Resolve every audience against `bayengage.segmentation` and record its size. An audience that cannot be
...
without confirming SMS consent through `bayengage.suppression_and_consent`.
