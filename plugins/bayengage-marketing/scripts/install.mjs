...
//
//   npx @targetbay/bayengage-marketing-skills            -> ./.claude/skills
//   npx @targetbay/bayengage-marketing-skills --global   -> ~/.claude/skills
//   npx @targetbay/bayengage-marketing-skills --dest DIR -> DIR
