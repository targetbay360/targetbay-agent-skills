...
metadata:
  ...
  targetbay.requires: bayengage.experimentation, bayengage.campaign_analytics, bayengage.segmentation, bayengage.order_intelligence
...
| Capability | Used for |
|---|---|
| `bayengage.experimentation` | Test configuration, variants, results, winner state |
| `bayengage.campaign_analytics` | Baseline and variance for the outcome metric |
| `bayengage.segmentation` | Sizing the testable audience |
| `bayengage.order_intelligence` | Revenue outcomes, which are usually the real metric |
...
| Situation | Response |
|---|---|
| `bayengage.experimentation` unavailable | **Blocked** for execution; the design can still be produced as a recommendation |
