...
metadata:
  ...
  targetbay.requires: bayengage.order_intelligence, bayengage.customer_intelligence, bayengage.product_intelligence, bayengage.segmentation, bayengage.campaign_analytics
...
| `bayengage.customer_intelligence` | Value bands, price sensitivity, headroom |
| `bayengage.product_intelligence` | Tiers, bundles, attachment candidates, margin signals |
| `bayengage.segmentation` | Sizing each lever's audience |
| `bayengage.campaign_analytics` | Prior AOV mechanic performance |
...
| Situation | Response |
|---|---|
| `bayengage.order_intelligence` unavailable | **Blocked.** The distribution is the input |
