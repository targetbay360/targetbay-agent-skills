...
metadata:
  ...
  targetbay.requires: bayengage.customer_intelligence, bayengage.order_intelligence, bayengage.product_intelligence, bayengage.segmentation, bayengage.suppression_and_consent, bayengage.campaign_analytics
...
| Capability | Used for |
|---|---|
| `bayengage.customer_intelligence` | Lifecycle, RFM, value, engagement, propensity signals |
| `bayengage.order_intelligence` | Purchase history, intervals, discount behaviour |
| `bayengage.product_intelligence` | Affinity, category and price-band relationships |
| `bayengage.segmentation` | Resolving and sizing audiences; reusing existing segments |
| `bayengage.suppression_and_consent` | Channel eligibility and suppression |
| `bayengage.campaign_analytics` | Which audiences have responded before |
...
| Situation | Response |
|---|---|
| `bayengage.segmentation` unavailable | **Blocked.** Audiences cannot be confirmed to exist (G4) |
