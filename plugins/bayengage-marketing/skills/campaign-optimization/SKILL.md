...
metadata:
  ...
  targetbay.requires: bayengage.campaign_management, bayengage.campaign_analytics, bayengage.customer_intelligence, bayengage.order_intelligence, bayengage.segmentation, bayengage.experimentation, bayengage.suppression_and_consent
...
| Capability | Used for |
|---|---|
| `bayengage.campaign_management` | Campaign configuration; creating variants after approval |
| `bayengage.campaign_analytics` | Full-funnel performance, comparisons, per-variant results |
| `bayengage.customer_intelligence` | Who actually responded versus who was targeted |
| `bayengage.order_intelligence` | Revenue and AOV attributable to the send |
| `bayengage.segmentation` | Audience definitions and sizes |
| `bayengage.experimentation` | Test configuration and results |
| `bayengage.suppression_and_consent` | Whether cadence or suppression shaped the result |
...
| Situation | Response |
|---|---|
| `bayengage.campaign_analytics` unavailable | **Blocked.** Diagnosis requires performance data |
