...
metadata:
  ...
  targetbay.requires: bayengage.campaign_analytics, bayengage.template_management, bayengage.customer_intelligence, bayengage.product_intelligence, bayengage.segmentation
...
| Capability | Used for |
|---|---|
| `bayengage.campaign_analytics` | Message performance and comparisons |
| `bayengage.template_management` | Existing content and blocks; creating variants after approval |
| `bayengage.customer_intelligence` | Who the audience is and what they respond to |
| `bayengage.product_intelligence` | Product facts, stock, what can be claimed |
| `bayengage.segmentation` | The audience the content is judged against |
