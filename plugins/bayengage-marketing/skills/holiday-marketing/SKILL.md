...
metadata:
  ...
  targetbay.requires: bayengage.store_profile, bayengage.customer_intelligence, bayengage.product_intelligence, bayengage.order_intelligence, bayengage.segmentation, bayengage.campaign_analytics, bayengage.marketing_calendar
...
| Capability | Used for |
|---|---|
| `bayengage.store_profile` | Vertical, markets, locale, scale |
| `bayengage.customer_intelligence` | Audience locale distribution, engagement, prior participation |
| `bayengage.product_intelligence` | Which products are genuinely occasion-relevant |
| `bayengage.order_intelligence` | Prior-period revenue shape around the date |
| `bayengage.segmentation` | Sizing the audience the holiday applies to |
| `bayengage.campaign_analytics` | Last year's holiday campaign results |
| `bayengage.marketing_calendar` | Surrounding commitments and collisions |
