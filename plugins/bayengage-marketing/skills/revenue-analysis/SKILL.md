...
metadata:
  ...
  targetbay.requires: bayengage.store_profile, bayengage.order_intelligence, bayengage.customer_intelligence, bayengage.product_intelligence, bayengage.campaign_analytics, bayengage.automation_analytics
...
| Capability | Used for |
|---|---|
| `bayengage.store_profile` | Scale and period context |
| `bayengage.order_intelligence` | Revenue, orders, AOV, frequency, cohorts |
| `bayengage.customer_intelligence` | Customer counts, lifecycle mix, value concentration |
| `bayengage.product_intelligence` | Product and category contribution |
| `bayengage.campaign_analytics` | Campaign-attributed revenue |
| `bayengage.automation_analytics` | Automation-attributed revenue |
...
| Situation | Response |
|---|---|
| `bayengage.order_intelligence` unavailable | **Blocked.** There is nothing to analyse |
