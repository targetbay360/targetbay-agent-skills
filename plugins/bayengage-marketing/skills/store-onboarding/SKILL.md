...
metadata:
  ...
  targetbay.requires: bayengage.store_profile, bayengage.customer_intelligence, bayengage.order_intelligence, bayengage.product_intelligence, bayengage.segmentation, bayengage.automation, bayengage.suppression_and_consent
...
| Capability | Used for |
|---|---|
| `bayengage.store_profile` | Vertical, scale, markets, plan limits |
| `bayengage.customer_intelligence` | What customer data exists, and how complete it is |
| `bayengage.order_intelligence` | Whether any order history is present to derive from |
| `bayengage.product_intelligence` | Catalogue shape, consumable versus durable |
| `bayengage.segmentation` | Which segments exist, and list sizes |
| `bayengage.automation` | Confirming there is no existing coverage |
| `bayengage.suppression_and_consent` | Consent state per channel; what may be sent |
...
- Never assume consent transferred from a prior platform. Confirm it through
  `bayengage.suppression_and_consent` (S7).
...
**"We've just moved to BayEngage — what should we set up?"**
