...
| `email_sms.order_intelligence` | Revenue by period, product and cohort; intervals; AOV distribution |
| `email_sms.customer_intelligence` | Lifecycle distribution, value concentration, engagement |
| `email_sms.product_intelligence` | Product performance, stock posture |
...
| `email_sms.marketing_calendar` | What is already committed this month |
