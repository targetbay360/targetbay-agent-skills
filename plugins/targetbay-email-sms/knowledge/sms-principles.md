...
> **Capability note.** SMS dispatch (`email_sms.messaging_sms`) is declared in
> [../capabilities.yaml](../capabilities.yaml) but has not been verified against a TargetBay Email & SMS MCP
...
`email_sms.suppression_and_consent`.
