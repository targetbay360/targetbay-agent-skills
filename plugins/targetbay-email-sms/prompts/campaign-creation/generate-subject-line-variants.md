---
title: Subject Line Variants Worth Testing
summary: Subject line directions across distinct angles for one send, with the pair to test first.
skill: content-optimization
---
Using TargetBay Email & SMS (`content-optimization` skill), give me subject line and preheader directions for my campaign to [SEGMENT] about [TOPIC].
