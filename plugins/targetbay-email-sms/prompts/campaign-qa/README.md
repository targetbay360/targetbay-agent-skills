...
|---|---|---|
| [Check Every Link Before Sending](audit-campaign-links-utm.md) | Broken, mistargeted or untracked links in one campaign, with a send verdict. | [`email-quality-auditor`](../../skills/email-quality-auditor/SKILL.md) |
...
| [Check Opt-Out and Sender Details](check-can-spam-compliance.md) | Whether an email's unsubscribe link, sender identity and footer meet commercial email law. | [`email-quality-auditor`](../../skills/email-quality-auditor/SKILL.md) |
| [Confirm the Send Time Fits This Audience](check-smart-sending-settings.md) | Whether a campaign's send time and time zone suit its audience, bounded by quiet hours. | [`send-time-optimization`](../../skills/send-time-optimization/SKILL.md) |
...
| [Gate SMS Copy for Restricted Content](check-sms-restricted-content.md) | A review gate that stops restricted topics and unsupported claims before automated SMS goes out. | [`ai-content-governance`](../../skills/ai-content-governance/SKILL.md) |
