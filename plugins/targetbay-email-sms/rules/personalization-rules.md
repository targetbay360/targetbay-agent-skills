...
### P1. Never personalise using data TargetBay Email & SMS cannot verify for that contact.
...
Product recommendations are drawn from `email_sms.product_intelligence` and the contact's own history.
