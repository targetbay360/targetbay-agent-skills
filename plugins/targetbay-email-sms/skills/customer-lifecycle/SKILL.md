...
| Capability | Used for |
|---|---|
| `email_sms.store_profile` | Vertical and scale context for stage shape |
| `email_sms.customer_intelligence` | Distribution across stages, engagement, value |
...
| `email_sms.customer_intelligence` unavailable | **Blocked** |
