...
//
//   npx @targetbay/loyalty-skills            -> ./.claude/skills
//   npx @targetbay/loyalty-skills --global   -> ~/.claude/skills
//   npx @targetbay/loyalty-skills --dest DIR -> DIR
...
const PLUGIN = "targetbay-loyalty";
const VERSION = (await readFile(join(PACKAGE_ROOT, "VERSION"), "utf8")).trim();

const args = process.argv.slice(2);

if (args.includes("--help") || args.includes("-h")) {
  console.log(`targetbay-loyalty-skills — install TargetBay Loyalty Skills
...
console.log("\nThese skills plan only. They need the TargetBay Loyalty MCP to read store data,");
