...
//
//   npx @targetbay/personalization-skills            -> ./.claude/skills
//   npx @targetbay/personalization-skills --global   -> ~/.claude/skills
//   npx @targetbay/personalization-skills --dest DIR -> DIR
...
if (args.includes("--help") || args.includes("-h")) {
  console.log(`targetbay-personalization-skills — install TargetBay Personalization Skills
...
console.log("\nThese skills plan only. They need the TargetBay Personalization MCP to read store data,");
