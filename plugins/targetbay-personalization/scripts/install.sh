#!/bin/sh
# Install TargetBay Personalization Skills without npm.
#
#   curl -fsSL https://raw.githubusercontent.com/targetbay360/targetbay-agent-skills/main/plugins/targetbay-personalization/scripts/install.sh | sh
...
PLUGIN="targetbay-personalization"
...
echo
echo "These skills plan only. They need the TargetBay Personalization MCP to read store data,"
