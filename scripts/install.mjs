...
//
//   npx @targetbay/targetbay-email-sms-marketing-skills            -> ./.claude/skills
//   npx @targetbay/targetbay-email-sms-marketing-skills --global   -> ~/.claude/skills
//   npx @targetbay/targetbay-email-sms-marketing-skills --dest DIR -> DIR
...
if (args.includes("--help") || args.includes("-h")) {
  console.log(`bayengage-skills — install TargetBay Email & SMS Marketing Skills
...
console.log("\nThese skills plan only. They need the BayEngage MCP to read store data,");
