...
metadata:
  ...
  targetbay.requires: bayengage.automation, bayengage.automation_analytics, bayengage.customer_intelligence, bayengage.order_intelligence, bayengage.segmentation, bayengage.experimentation
...
| Capability | Used for |
|---|---|
| `bayengage.automation` | Current topology; applying changes after approval |
| `bayengage.automation_analytics` | Per-node drop-off, completion, revenue per entrant |
| `bayengage.customer_intelligence` | Who enters and who completes |
| `bayengage.order_intelligence` | Whether conversion happens outside the attributed window |
| `bayengage.segmentation` | Entry audience composition and size |
| `bayengage.experimentation` | Testing a change inside the journey |
...
| Situation | Response |
|---|---|
| `bayengage.automation_analytics` unavailable | **Blocked.** Node-level diagnosis needs node-level data |
