...
metadata:
  ...
  targetbay.requires: bayengage.store_profile, bayengage.customer_intelligence, bayengage.product_intelligence, bayengage.order_intelligence, bayengage.segmentation, bayengage.automation, bayengage.automation_analytics, bayengage.campaign_analytics
...
| `bayengage.customer_intelligence` | Lifecycle distribution, transition leakage, value concentration |
| `bayengage.product_intelligence` | Catalogue shape, categories, replenishable products |
| `bayengage.order_intelligence` | Repeat intervals, frequency, AOV distribution |
| `bayengage.segmentation` | Sizing candidate journey audiences |
| `bayengage.automation` | Reading the existing portfolio |
| `bayengage.automation_analytics` | Per-journey and per-node performance |
| `bayengage.campaign_analytics` | Detecting manual sends that should be automations |
...
- [ ] Every gap sized against `bayengage.segmentation` (A1)
...
| Situation | Response |
|---|---|
| `bayengage.automation` unavailable | **Blocked.** The audit is the skill |
