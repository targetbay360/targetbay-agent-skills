...
metadata:
  ...
  targetbay.requires: bayengage.customer_intelligence, bayengage.campaign_analytics, bayengage.automation_analytics, bayengage.segmentation, bayengage.suppression_and_consent, bayengage.messaging_sms
...
| Capability | Used for |
|---|---|
| `bayengage.customer_intelligence` | Channel preference and engagement per segment |
| `bayengage.campaign_analytics` | Per-channel campaign performance |
| `bayengage.automation_analytics` | Per-channel node performance in journeys |
| `bayengage.segmentation` | Sizing channel-eligible audiences |
| `bayengage.suppression_and_consent` | Consent per channel, quiet hours, caps |
| `bayengage.messaging_sms` | SMS availability. **Unverified** — see [../../docs/mcp-integration.md](../../docs/mcp-integration.md) |
...
- Where `bayengage.messaging_sms` is unavailable, produce an email-only strategy and record the gap
...
| Situation | Response |
|---|---|
| `bayengage.messaging_sms` unavailable | **Partial.** Produce an email-only strategy; record where SMS would have been used |
