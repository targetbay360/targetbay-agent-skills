...
| Capability | Used for |
|---|---|
| `bayengage.product_intelligence` | Affinity, co-purchase, categories, stock |
| `bayengage.customer_intelligence` | Category breadth, value, engagement |
| `bayengage.order_intelligence` | Purchase history, sequence and timing of category entry |
| `bayengage.segmentation` | Sizing candidate audiences |
| `bayengage.campaign_analytics` | Prior cross-sell performance |
...
| Situation | Response |
|---|---|
| `bayengage.product_intelligence` unavailable | **Blocked.** Affinity is the basis of the skill |
