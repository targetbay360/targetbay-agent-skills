...
metadata:
  ...
  targetbay.requires: bayengage.customer_intelligence, bayengage.order_intelligence, bayengage.product_intelligence, bayengage.segmentation, bayengage.automation, bayengage.automation_analytics, bayengage.campaign_analytics
...
| Capability | Used for |
|---|---|
| `bayengage.customer_intelligence` | Lifecycle stage, churn signals, engagement, value |
| `bayengage.order_intelligence` | Cohort repeat rates, intervals, frequency |
| `bayengage.product_intelligence` | Replenishables, affinity for the next purchase |
| `bayengage.segmentation` | Sizing retention audiences |
| `bayengage.automation` / `bayengage.automation_analytics` | Existing coverage and its performance |
| `bayengage.campaign_analytics` | Prior retention campaign results |
