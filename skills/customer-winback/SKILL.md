...
metadata:
  ...
  targetbay.requires: bayengage.customer_intelligence, bayengage.order_intelligence, bayengage.product_intelligence, bayengage.segmentation, bayengage.campaign_analytics, bayengage.suppression_and_consent
...
| Capability | Used for |
|---|---|
| `bayengage.customer_intelligence` | Lapse state, prior value, engagement recency |
| `bayengage.order_intelligence` | Purchase history, intervals, what they used to buy |
| `bayengage.product_intelligence` | What is new or relevant to their prior affinity |
| `bayengage.segmentation` | Sizing win-back audiences by value and reachability |
| `bayengage.campaign_analytics` | Prior win-back results |
| `bayengage.suppression_and_consent` | Reachability, complaint risk, suppression state |
