...
| Capability | Used for |
|---|---|
| `bayengage.store_profile` | Vertical, locale, scale, sending posture |
| `bayengage.customer_intelligence` | Audience availability, engagement, channel preference |
| `bayengage.product_intelligence` | Relevant products, categories, stock posture |
| `bayengage.order_intelligence` | Prior-period revenue shape, purchase timing within the window |
| `bayengage.segmentation` | Sizing each arc's audience |
| `bayengage.campaign_management` | Creating the sequence after approval |
| `bayengage.campaign_analytics` | Last year's performance by stage |
| `bayengage.marketing_calendar` | Collisions across the period |
| `bayengage.suppression_and_consent` | Channel eligibility, quiet hours |
