...
metadata:
  ...
  targetbay.requires: bayengage.store_profile, bayengage.order_intelligence, bayengage.product_intelligence, bayengage.customer_intelligence, bayengage.campaign_analytics, bayengage.automation, bayengage.marketing_calendar
...
| Capability | Used for |
|---|---|
| `bayengage.store_profile` | Vertical, markets, scale |
| `bayengage.order_intelligence` | Seasonality and revenue concentration by period |
| `bayengage.product_intelligence` | Catalogue rhythm, launches, stock cycles |
| `bayengage.customer_intelligence` | Audience availability and engagement across the horizon |
| `bayengage.campaign_analytics` | Prior-period performance |
| `bayengage.automation` | Baseline contact load |
| `bayengage.marketing_calendar` | Occupancy and commitments across the horizon |
...
| Situation | Response |
|---|---|
| `bayengage.marketing_calendar` unavailable | **Blocked.** Planning blind to commitments risks collisions |
