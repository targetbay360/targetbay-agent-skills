...
metadata:
  ...
  targetbay.requires: bayengage.store_profile, bayengage.customer_intelligence, bayengage.product_intelligence, bayengage.order_intelligence, bayengage.segmentation, bayengage.campaign_management, bayengage.campaign_analytics, bayengage.automation, bayengage.marketing_calendar, bayengage.suppression_and_consent
...
| `bayengage.customer_intelligence` | Audience availability, lifecycle mix, engagement |
| `bayengage.product_intelligence` | What to promote, launches, categories, stock posture |
| `bayengage.order_intelligence` | Seasonality, revenue concentration, repeat intervals |
| `bayengage.segmentation` | Sizing every planned audience |
| `bayengage.campaign_management` | Existing and draft campaigns; creating the plan after approval |
| `bayengage.campaign_analytics` | What has worked historically |
| `bayengage.automation` | Contact load already committed |
| `bayengage.marketing_calendar` | Occupancy and collisions |
| `bayengage.suppression_and_consent` | Channel eligibility and frequency caps |
...
| EXECUTE | Create drafts via `bayengage.campaign_management` | `mutation` |
...
| Situation | Response |
|---|---|
| `bayengage.marketing_calendar` unavailable | **Blocked.** Planning blind risks collisions with committed sends |
