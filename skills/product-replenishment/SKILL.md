...
metadata:
  ...
  targetbay.requires: bayengage.product_intelligence, bayengage.order_intelligence, bayengage.customer_intelligence, bayengage.segmentation, bayengage.automation, bayengage.automation_analytics
...
| Capability | Used for |
|---|---|
| `bayengage.product_intelligence` | Attributes, size, format, stock |
| `bayengage.order_intelligence` | Repeat intervals per product and per customer |
| `bayengage.customer_intelligence` | Individual patterns, engagement, value |
| `bayengage.segmentation` | Sizing each replenishment audience |
...
| Situation | Response |
|---|---|
| `bayengage.order_intelligence` unavailable | **Blocked.** Intervals cannot be derived |
