...
metadata:
  ...
  targetbay.requires: bayengage.store_profile, bayengage.customer_intelligence, bayengage.product_intelligence, bayengage.order_intelligence, bayengage.segmentation, bayengage.campaign_analytics, bayengage.automation, bayengage.automation_analytics, bayengage.marketing_calendar
...
| Capability | Used for |
|---|---|
| `bayengage.store_profile` | Vertical, scale, constraints |
| `bayengage.customer_intelligence` | Lifecycle distribution, value bands, churn and purchase signals |
| `bayengage.product_intelligence` | Product and category performance, affinity, stock |
| `bayengage.order_intelligence` | Revenue decomposition, frequency, AOV, discount dependence |
| `bayengage.segmentation` | Sizing every opportunity's audience |
...
| `bayengage.marketing_calendar` | Executable capacity in the period |
