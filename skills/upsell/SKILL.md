...
metadata:
  ...
  targetbay.requires: bayengage.customer_intelligence, bayengage.product_intelligence, bayengage.order_intelligence, bayengage.segmentation, bayengage.campaign_analytics
...
| Capability | Used for |
|---|---|
| `bayengage.order_intelligence` | AOV distribution, basket composition, threshold behaviour |
| `bayengage.customer_intelligence` | Price-band behaviour, value, discount dependence |
| `bayengage.product_intelligence` | Tiers, bundles, sizes, subscriptions, margin signals |
| `bayengage.segmentation` | Sizing candidate audiences |
| `bayengage.campaign_analytics` | Prior upsell and threshold results |
...
| Situation | Response |
|---|---|
| `bayengage.order_intelligence` unavailable | **Blocked.** AOV work needs the distribution |
